...
std::vector<std::string> StringHelper::splitUsingSemiColon(const std::string& src)
{
	std::vector<std::string> accum;
	std::string temp;
	size_t index = 0;
...
std::vector<std::string> StringHelper::splitUsingHyphen(const std::string& src)
{
	std::vector<std::string> accum;
	std::string temp;
	size_t index = 0;
...
std::vector<std::string> StringHelper::splitUsingDecimalDot(const std::string& src)
{
	std::vector<std::string> accum;
	std::string temp;
	size_t index = 0;
