...
namespace Utilities
{
  ...
  public:
	...
	static std::vector<std::string> splitUsingSemiColon(const std::string& src);
	static std::vector<std::string> StringHelper::splitUsingHyphen(const std::string& src);
	static std::vector<std::string> splitUsingDecimalDot(const std::string & src);
